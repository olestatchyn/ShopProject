    ...
    <div className={cl.about}>
      <div className={cl.about__background}>
        <div className={cl.about__contacts}>
          <div className={cl.about__contacts__column}>
            ...
            <div className={cl.about__contacts__title}>Facebook</div>
          ...
          <div className={cl.about__contacts__column}>
            ...
            <div className={cl.about__contacts__title}>Instagram</div>
            <div className={cl.about__contacts__text}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit ut
              aliquam, purus sit amet luctus venenatis
            </div>
          ...
          <div className={cl.about__contacts__column}>
            ...
            <div className={cl.about__contacts__title}>Gmail</div>
            <div className={cl.about__contacts__text}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit ut
              aliquam, purus sit amet luctus venenatis
            </div>
      ...
      <div className={main.container}>
        <div className={cl.about__content}>
            ...
            <div className={cl.about__content__item}>
              ...
              <div className={cl.about__content__text}>
                <p>
                  ...
                  pulvinar adipiscing eleifend turpis vitae. Cursus feugiat quis
                  nisl, felis facilisis eu faucibus. Egestas pretium dictumst
                  tortor amet, faucibus pulvinar bibendum. Aliquam, varius
                  egestas nisl, in pharetra proin.
                </p>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ac
                  pulvinar adipiscing eleifend turpis vitae.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className={cl.about__content__row}>
            ...
            <div className={cl.about__content__item}>
              <div className={cl.about__content__title}>Швидко та смачно</div>
              <div className={cl.about__content__text}>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ac
                  pulvinar adipiscing eleifend turpis vitae. Cursus feugiat quis
          ...
          <div className={cl.about__content__row}>
            ...
            <div className={cl.about__content__item}>
              <div className={cl.about__content__title}>Особливий рецепт</div>
              <div className={cl.about__content__text}>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ac
                  pulvinar adipiscing eleifend turpis vitae. Cursus feugiat quis
      ...
      <div className={cl.about__map}>
        <div className={cl.about__map__info}>
          ...
          <div className={cl.about__map__info__email}>primepizza@gmail.com</div>
          <div className={cl.about__map__info__phone}>+ 38 (095) 208 1079</div>
